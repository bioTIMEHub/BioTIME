...
ds_name <- "OperationWallacea_Mexico_reptiles"
...
ds <- read.csv("BioTIMEContributorTemplate_MexReptilesOPWALL_rawdata.csv")
...
write.csv(rawdata, paste0(ds_name, "_RAWDATA_VB_v2.csv"), row.names = FALSE)
