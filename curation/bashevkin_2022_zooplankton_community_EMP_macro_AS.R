...
# Dataset: bashevkin_2022_zooplankton_community_EMP_macro
...
dataset.name <- 'bashevkin_2022_zooplankton_community_EMP_macro'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'EMP' & SizeClass == 'Macro' & !Undersampled & CPUE > 0)
