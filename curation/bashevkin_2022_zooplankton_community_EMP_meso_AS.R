...
# Dataset: bashevkin_2022_zooplankton_community_EMP_meso
...
dataset.name <- 'bashevkin_2022_zooplankton_community_EMP_meso'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'EMP' & SizeClass == 'Meso' & !Undersampled & CPUE > 0)
