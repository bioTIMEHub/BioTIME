...
# Dataset: bashevkin_2022_zooplankton_community_FMWT_macro
...
dataset.name <- 'bashevkin_2022_zooplankton_community_FMWT_macro'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'FMWT' & SizeClass == 'Macro' & !Undersampled & CPUE > 0)
