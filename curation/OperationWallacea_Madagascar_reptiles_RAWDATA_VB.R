## Curation script for OpWal: Madagascar Reptiles
## curator VB

setwd("D:/Dropbox/towards BioTIME v2/Vivi-dataset hunting files/OpWal/BioTIMEv02/BioTIMEv02")
ds_name <- "OperationWallacea_Madagascar_reptiles"
...
ds <- read.csv("BioTIMEContributorTemplate_MadReptilesOPWALL_rawdata.csv")
...
write.csv(dt[duplicated(dt[,2:14]),4:13], "double_entries_OpWall_Madagascar_rreptiles.csv", row.names = FALSE)
