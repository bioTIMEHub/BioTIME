...
# Dataset: Ground vegetation data ICP Forests Level II plot Gontrode
# Location: Belgium
# Curator: Cher Chow
# Date: 16-Oct-2020
...
dt <- read_excel('Originals/INBO_Gontrode.xlsx', sheet=1, col_names=T, na='')
...
dt$Species <- dt$Species %>% str_replace_all(., 'galeobdolon subsp. argentatum$', 'galeobdolon') # no subspecies or vars
...
write.csv(dt_merged, 'ICP_Level2_Gontrode_rawdata_CC.csv', row.names=F)
library(clipr)
