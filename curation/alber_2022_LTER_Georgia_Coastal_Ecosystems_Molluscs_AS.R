...
# Dataset: alber_2022_LTER_Georgia_Coastal_Ecosystems_Molluscs_0.5
...
dt <- dt %>% dplyr::filter(Quadrat_Area == 0.5 & Mollusc_Count != 0) %>%
...
# Export final ------------------------------------------------------------
dataset.name <- 'alber_2022_LTER_Georgia_Coastal_Ecosystems_Molluscs_0.5'
