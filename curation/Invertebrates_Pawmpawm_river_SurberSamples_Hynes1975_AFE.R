...
# Read Data ====================================================================
files_dir <- "C:/Users/afe1/OneDrive - University of St Andrews/PHD/BIOTIME/BioTIMENewStudiesCuration/Invertebrates_Pawmpawm_river_SurberSamples_Hynes1975_AFE"
dt <- read.csv(paste0(files_dir, "/transcript_surberHynes1975a.csv"), h=T) # data entered manually by AFE from manuscript with authors permission
str(dt)


# Abundance ====================================================================
sum(is.na(dt$Counts))        # 0
sum(dt$Counts==0)            # 192
dt <- dt[!dt$Counts==0,]     # 185 observations
...
dt$Month <- as.integer(plyr::revalue(dt$Month, c("April"="4", 
                                                 "August"="8",
                                                 "December"="12",
                                                 "February"="2",
                                                 "January"="1",
...
# Taxonomy =====================================================================
sort(unique(dt$Taxa))
dt$Taxa <- plyr::revalue(dt$Taxa, c("Austrocaenis sp."="Austrocaenis sp",
                                    "Centroptiloides spp."="Centroptiloides sp",
                                    "Centroptilum spp." ="Centroptilum sp",
                                    "Cheumatopsyche spp."="Cheumatopsyche sp",
                                    "Cladocera, Ostracoda and Cyclops"="Arthropoda",
                                    "Cloeon sp."="Cloeon sp",
                                    "Dugesia"="Dugesia sp",
                                    "Elminthidae adults"="Elminthidae",
                                    "Elminthidae larvae"="Elminthidae",
                                    "Gyrinidae and Dytiscidae larvae"="Coleoptera",
                                    "Libellulidae sp. 1"="Libellulidae sp",
                                    "Other Anisoptera"="Anisoptera",
                                    "Other Diptera larvae"="Diptera",
                                    "Other Ephemeroptera"="Ephemeroptera",
                                    "Other Trichoptera"="Trichoptera",
                                    "Pisidium sp."="Pisidium sp",
                                    "Protodipseudopsis sp."="Protodipseudopsis sp",
                                    "Simulium spp."="Simulium sp"))
sort(unique(dt$Taxa)) 
...
toFamily <- c("Anisoptera", "Annelida", "Arthropoda", "Chironomidae", "Coleoptera", "Diptera", 
              "Elminthidae", "Ephemeroptera", "Gastropoda", "Hemiptera", "Hydracarina", "Hydroptilidae",
              "Libellulidae", "Pyraustidae", "Testacea", "Trichoptera", "Zygoptera")
...
# Save =========================================================================
path <- "C:/Users/afe1/OneDrive - University of St Andrews/PHD/BIOTIMEGithubMetadatas/Invertebrates_Pawmpawm_river_SurberSamples_Hynes1975_AFE"
