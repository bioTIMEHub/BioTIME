...
# Dataset: bashevkin_2022_zooplankton_community_FRP_meso
...
dataset.name <- 'bashevkin_2022_zooplankton_community_FRP_meso'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'FRP' & SizeClass == 'Meso' & !Undersampled & CPUE > 0)
