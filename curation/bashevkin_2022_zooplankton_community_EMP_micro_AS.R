...
# Dataset: bashevkin_2022_zooplankton_community_EMP_micro
...
dataset.name <- 'bashevkin_2022_zooplankton_community_EMP_micro'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'EMP' & SizeClass == 'Micro' & !Undersampled & CPUE > 0)
