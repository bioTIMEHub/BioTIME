# Dataset: CERN_Yunnan_Xishuangbanna_herbs
...
setwd("C:/Dropbox/iDiv/Data/BTDataCuration_2023/wubing/CERN_Yunnan_Xishuangbanna_herbs_WBX")
...
# plot 1
dat_plot1 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳热带季节雨林综合观测场", range = "A2:C627")
...
# plot 2
dat_plot2 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳热带次生林辅助观测场", range = "A2:C166")
...
# plot 3
dat_plot3 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳窄序崖豆树热带次生林站区调查点", range = "A2:C110")
colnames(dat_plot3) <- c("Year", "species_cn", "Abundance")

# plot 4
dat_plot4 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳曼安热带次生林站区调查点", range = "A2:C139")
colnames(dat_plot4) <- c("Year", "species_cn", "Abundance")

# plot 5
dat_plot5 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳石灰山季雨林站区调查点", range = "A2:C50")
colnames(dat_plot5) <- c("Year", "species_cn", "Abundance")

# plot 6
dat_plot6 <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_草本层植物种组成.xlsx', 
                        sheet= "西双版纳次生常绿阔叶林站区调查点", range = "A2:C60")
...
# species list
species_list <- read_excel('CERN_Yunnan_Xishuangbanna_herbs_original_WBX/实体数据/版纳站生物数据_植物名录.xlsx', 
...
write_excel_csv(species_nomatched, file = "CERN_Yunnan_Xishuangbanna_herbs_findSpeciesName.csv")
species_nomatched <- read_excel("CERN_Yunnan_Xishuangbanna_herbs_findSpeciesName_manual.xlsx", sheet=1)
...
write_excel_csv(dat_out, file = "CERN_Yunnan_Xishuangbanna_herbs_WBX_rawdata.csv")
