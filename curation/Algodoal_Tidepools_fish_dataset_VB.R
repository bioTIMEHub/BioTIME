## Curation script for Algodoal Tidepools dataset
## curator VB

setwd("D:/Dropbox/towards BioTIME v2/Vivi-dataset hunting files/Ale-Brazil")
ds_name <- "Algodoal_Tidepools_fish_dataset"
...
ds <- read_excel("Algodoal Tidepools dataset_raw.xlsx", sheet = "rawData")
...
# fix taxonomy
ds$Species[ds$Species == "Gymnothorax aff. funebris"] <- "Gymnothorax funebris"
# ds$Species[ds$Species == "Mugil cf curema"] <- "Mugil curema"
# ds$Species[ds$Species == "Mugil aff. curema"] <- "Mugil sp1"
# ds$Species[ds$Species == "Mugil sp."] <- "Mugil sp2"
# ds$Species[ds$Species == "Mugil aff. hospes"] <- "Mugil hospes"
ds$Species[ds$Species == "Serranidae sp."] <- "Genus1 sp."

ds$Species[ds$Species == "Mugil cf curema"] <- "Mugil sp"
ds$Species[ds$Species == "Mugil aff. curema"] <- "Mugil sp"
ds$Species[ds$Species == "Mugil sp."] <- "Mugil sp"
ds$Species[ds$Species == "Mugil aff. hospes"] <- "Mugil sp"
