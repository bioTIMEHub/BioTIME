...
# Dataset: bashevkin_2022_zooplankton_community_FMWT_meso
...
dataset.name <- 'bashevkin_2022_zooplankton_community_FMWT_meso'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'FMWT' & SizeClass == 'Meso' & !Undersampled & CPUE > 0)
