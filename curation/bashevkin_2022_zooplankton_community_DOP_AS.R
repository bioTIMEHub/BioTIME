...
# Dataset: bashevkin_2022_zooplankton_community_DOP_meso
...
dataset.name <- 'bashevkin_2022_zooplankton_community_DOP_meso'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'DOP' & SizeClass == 'Meso' & !Undersampled & CPUE > 0)
