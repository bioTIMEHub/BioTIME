### Biotime v1 fix: Thorn mosses soil
## Curator: VB
...
dt_ul <- read_excel("BioTIMETemplate_moss_soil_unlogged.xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_moss_soil_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_mosses_soil_recurate_merged_VB.csv")
write_clip(dt)
