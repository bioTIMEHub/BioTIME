### Biotime fix of Thorn mosses obj
## Curator: VB
...
dt_ul <- read_excel("BioTIMETemplate_moss_obj_unlogged.xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_moss_obj_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_mosses_obj_recurate_merged_VB.csv")
