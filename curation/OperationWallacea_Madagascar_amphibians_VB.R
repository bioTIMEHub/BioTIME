## Curation script for OpWal: Madagascar Amphibians
## curator VB

setwd("D:/Dropbox/towards BioTIME v2/Vivi-dataset hunting files/OpWal/BioTIMEv02/BioTIMEv02")
ds_name <- "OperationWallacea_Madagascar_amphibians"
...
ds <- read.csv("BioTIMEContributorTemplate_MadAmphibiansOPWALL_rawdata.csv")
