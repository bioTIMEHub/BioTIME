...
# Dataset: bashevkin_2022_zooplankton_community_20mm_meso
...
dataset.name <- 'bashevkin_2022_zooplankton_community_20mm_meso'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == '20mm' & SizeClass == 'Meso' & !Undersampled & CPUE > 0)
