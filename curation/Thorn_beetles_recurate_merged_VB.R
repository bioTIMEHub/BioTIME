...
dt_ul <- read_excel("BioTIMETemplate_beetles_unlogged .xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_beetles_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_beetles_recurate_merged_VB.csv")
write_clip(dt)
