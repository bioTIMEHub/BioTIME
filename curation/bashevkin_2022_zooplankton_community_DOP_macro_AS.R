...
# Dataset: bashevkin_2022_zooplankton_community_DOP_macro
...
dataset.name <- 'bashevkin_2022_zooplankton_community_DOP_macro'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'DOP' & SizeClass == 'Macro' & !Undersampled & CPUE > 0)
