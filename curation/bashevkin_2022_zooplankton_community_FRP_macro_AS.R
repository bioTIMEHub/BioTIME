...
# Dataset: bashevkin_2022_zooplankton_community_FRP_macro
...
dataset.name <- 'bashevkin_2022_zooplankton_community_FRP_macro'
...
dt <- dt %>% dplyr::select('Source','Station','Latitude','Longitude','Date','SampleID',
  ...
  dplyr::filter(Source == 'FRP' & SizeClass == 'Macro' & !Undersampled & CPUE > 0)
