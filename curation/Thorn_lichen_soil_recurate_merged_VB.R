### Biotime fix of Thorn lichen soil
## Curator: VB
...
dt_ul <- read_excel("BioTIMETemplate_lichen_soil_unlogged.xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_lichen_soil_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_lichen_soil_recurate_merged_VB.csv")
