...
mypath <- getwd() # for reference, my default is my working BioTIME folder
dt <- read_excel('Originals/HaasePilotto/S007.xlsx', sheet=1, skip=3, col_names=T, na='')
...
write.csv(dt_merged, 'LTER_HogeKempenNationalPark_Arachnids_rawdata_CC.csv', row.names=F)
library(clipr)
