### Biotime v1 fix: Thorn plants soil
## Curator: VB
...
dt_ul <- read_excel("BioTIMETemplate_plants_soil_unlogged.xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_plants_soil_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_plants_soil_recurate_merged_VB.csv")
write_clip(dt)
