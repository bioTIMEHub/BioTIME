### Biotime fix of Thorn lichen obj
## Curator: VB
...
dt_ul <- read_excel("BioTIMETemplate_lichen_obj_unlogged.xlsx", sheet = "rawData") 
dt_l <- read_excel("BioTIMETemplate_lichen_obj_logged.xlsx", sheet = "rawData") 
...
write.csv(dt,"Thorn_lichen_obj_recurate_merged_VB.csv")
write_clip(dt)
